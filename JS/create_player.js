...
function fitStageIntoParentContainer(stage, width, height) {
    
    let container = document.getElementById('stage-parent');
    ...
    stage.attrs.width = canvasWidth * scale;
    stage.attrs.height = canvasWidth * scale;
    stage.attrs.scale ={ x: scale, y: scale };
}

fitStageIntoParentContainer(stage,canvasWidth, canvasHeight )
